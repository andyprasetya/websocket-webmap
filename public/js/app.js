var map,openStreetMap,esriWorldImageryMap,zoomControl,attributionControl,scaleControl,layerControl,baseLayers,isCollapsed,
	earthquakeLayer,pulsingIcon1,pulsingIcon2,pulsingIcon3,mapHash,usgs_geojson_request,inasafe_geojson_request,earthquakes,realTimeShift;
...
realTimeShift = L.easyButton('fa-toggle-off fa-lg text-default', function (btn, map){window.open('./realtime','_self');});
